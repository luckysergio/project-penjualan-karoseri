...
<head>
    ...
    <title>Login - PT. HARAPAN DUTA PERTIWI</title>
...
<body
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
            <form action="/login1" method="POST" class="space-y-6">
                @csrf
                @method('POST')
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Belum punya akun?
                    <a href="/register" class="font-medium text-purple-600 hover:text-purple-800 transition-colors">
                        Daftar sekarang
                    </a>
                </p>
            </div>
