    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex justify-end mb-6">
            <a href="/pengiriman/create"
                class="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl font-semibold transition duration-200">
        ...
        <div id="pengiriman-container">
            @if ($pengirimans->isEmpty())
                <div class="p-6 bg-yellow-100 text-yellow-700 rounded-lg text-center shadow">
                    Anda belum memiliki pengiriman.
                </div>
            @else
