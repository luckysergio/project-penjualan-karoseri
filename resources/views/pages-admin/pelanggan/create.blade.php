...
@section('content')
    ...
    <div class="max-w-2xl mx-auto mt-10">
        <div class="bg-white shadow-lg rounded-xl p-6 sm:p-8">
            <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-6 text-center">Form Tambah Pelanggan</h2>
            <form action="{{ url('/pelanggan') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="instansi" id="instansi"
                        ...
                        value="{{ old('instansi') }}" placeholder="Masukkan instansi (jika ada)">
                    @error('instansi')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
