...
<div class="max-w-xl mx-auto mt-10">
    <div class="bg-white shadow-lg rounded-xl p-6 sm:p-8">
        <h2 class="text-xl sm:text-2xl font-bold text-gray-800 mb-6 text-center">Form Tambah Jenis</h2>
        <form action="{{ url('/jenis') }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="nama" id="nama"
                    ...
                    value="{{ old('nama') }}" placeholder="Jenis Dump">
                @error('nama')
