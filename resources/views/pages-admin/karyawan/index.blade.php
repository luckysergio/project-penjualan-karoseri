            ...
            <table class="min-w-full text-sm text-left">
                <thead class="bg-gray-100 text-gray-700 uppercase text-xs tracking-wider">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-center">NIK</th>
                ...
                <tbody class="divide-y divide-gray-200 text-gray-700">
                    @forelse ($karyawans as $karyawan)
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4 text-center font-medium">{{ $karyawan->user->name }}</td>
                            <td class="px-6 py-4 text-center">{{ $karyawan->user->email }}</td>
                            <td class="px-6 py-4 text-center">{{ $karyawan->nik }}</td>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex justify-center gap-2">
                                    ...
                                    <button onclick="confirmDelete('{{ $karyawan->id }}', '{{ $karyawan->user->name }}')"
                                        class="inline-flex items-center justify-center w-9 h-9 rounded-full text-white shadow transition"
